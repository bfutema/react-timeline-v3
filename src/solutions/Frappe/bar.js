...
export default class Bar {
  ...
  prepare_values() {
    ...
    this.group = createSVG('g', { class: 'bar-wrapper ' + (this.task.custom_class || ''), 'data-id': this.task.id });
    this.bar_group = createSVG('g', { class: 'bar-group', append_to: this.group });
    this.handle_group = createSVG('g', { class: 'handle-group', append_to: this.group });
  }
  ...
  show_popup() {
    ...
    this.gantt.show_popup({ target_element: this.bar, title: this.task.name, subtitle: subtitle, task: this.task });
  }
  ...
  update_bar_position({ x = null, width = null }) {
    ...
    if (width && width >= this.gantt.options.column_width) this.update_attr(bar, 'width', width);
  ...
  update_attr(element, attr, value) {
    ...
    if (!isNaN(value)) element.setAttribute(attr, value);
  ...
  update_arrow_position() {
    ...
    for (let arrow of this.arrows) arrow.update();
  }
}
